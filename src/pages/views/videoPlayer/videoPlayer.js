        ...
        <div className="top-header-img-container">
          <div className="header-img-inside-container">
            <div onClick={VideoPlay} className="img-header-container">
              <img src={videoImg} />
              <p>{language == "english" ? "Video" : "காணொளி"}</p>
            </div>
            <div
              onClick={PDFPage}
            ...
            >
              <img src={pdfImg} />
              <p>{language == "english" ? "PDF" : "பீடிஎஃப்"}</p>
            </div>
            <div
      ...
      {topicChanges === "video" ? (
        <div className="ps-2">
          ...
          <div className="video-base-container">
            ...
            >
              {language == "english" ? "Video Content" : "காணொளி உள்ளடக்கம்"}
            </p>
            <p
            ...
            >
              {language == "english" ? "FAQs" : "அடிக்கடி கேட்கப்படும் கேள்விகள்"}
            </p>
            <p
